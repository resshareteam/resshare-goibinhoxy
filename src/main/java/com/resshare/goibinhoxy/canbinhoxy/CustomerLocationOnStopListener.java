...
public class CustomerLocationOnStopListener extends ListenerBase {
...

				{
					...
					FirebaseDatabase.getInstance()
							.getReference(ResFirebaseReference
									.getDataPathReference(FirebaseRefOxy.order + "/" + order_key + "/customer_info/current/event"))
							.setValue(null);
	...
	public String getReferenceName() {
		...
		return ResFirebaseReference.getInputPathReference(FirebaseRefOxy.customer_location_on_stop);
	}
